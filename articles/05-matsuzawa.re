...
いくらSREチームのポテンシャルが高いからと言っても、やはり強い武器や防具を装備をしていなければ強敵へと挑むのには無理があります。ぜひNew Relicという強力なツールを装備してから冒険へと旅立つことをオススメします。では次の節からは、FinOpsのライフサイクルごとの具体的なNew Relicの活用方法について見ていきましょう。

== 5.2. Informフェーズ：コストの可視化と
